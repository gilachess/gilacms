# GilaCMS
    ...
    **GilaCMS** is a lightweight, responsive, and performance-optimized custom blogging CMS backed by **SQLite**. It includes a dynamic theme
  toggle (Dark/Light mode), SEO best practices (dynamic XML Sitemap, RSS feeds, schema.org tags), clean URL routing, and a pluggable modular admin
  editor.
    
    It features an automated WordPress REST API migration scraper to pull posts, categories, tags, and download media assets directly into the
  SQLite database.
  ...
  Add a local location block to route pretty URLs to  index.php :
    ...
    location /gilacms/ {
        ...
        try_files uriuri//gilacms/index.php?args;
    }
